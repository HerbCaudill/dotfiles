...
The September 15 helper checks passed before live useful-data provisioning was possible. On September 16, C: was extended and a 2 GiB WinRE partition recreated; a coordinated default dev/example SQL/blob snapshot was then captured and verified. Subsequent public-command proof restored and started three useful-data environments, independently verified their built schemas, and demonstrated source/data/process isolation. Two populated dashboards passed normal-Chrome checks. These are separate stages of evidence: see the [partition repair](INSTALLATION-EVIDENCE.md#september-16-partition-repair), coordinated capture and [live acceptance](INSTALLATION-EVIDENCE.md#september-16-useful-data-acceptance), including the inherited missing-attachment limitation. Remeasure Windows and physical Mac capacity before further provisioning.
