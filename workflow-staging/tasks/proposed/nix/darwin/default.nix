...
in
{
  assertions = [
    {
      assertion = tasksAgent.enable && tasksAgent.spaceId != null && tasksAgent.spaceId != "";
      message = "Tasks workflow cutover requires the enabled peer and reviewed spaceId.";
    }
  ];
